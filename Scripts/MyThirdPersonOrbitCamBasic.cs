...
public class MyThirdPersonOrbitCamBasic : MonoBehaviour 
{
    ...
    public float maxDistance = 5f;                                     // Max camera distance
    public float minDistance = 1f;                                     // Min camera distance
    public int zoomRate = 10;                                          // Camera zoom speed
    public float zoomDampening = 3f;                                   // Camera zoom smoothness
    ...
    private float distance = 1;                                        // Default camera distance.
    private float desiredDistance;                                     // Used for calcutations of camera distance.
    private float correctedDistance;                                  // Used for calcutations of camera distance.
	...
	void LateUpdate()
	{
        if (!GameControl.isPaused)
        {
            ...
            correctedDistance = Mathf.Lerp(correctedDistance, desiredDistance, Time.deltaTime * zoomDampening); ;
            ...
            cam.position = player.position + camYRotation * smoothPivotOffset + aimRotation * smoothCamOffset - aimRotation * Vector3.forward * correctedDistance;
        }
    }
